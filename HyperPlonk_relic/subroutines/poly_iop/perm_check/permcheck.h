...
public:
    ...
    prove(
        ...
        const std::vector<shared_ptr<DenseMultilinearExtension<scalar_field>>> &fxs,
        const std::vector<shared_ptr<DenseMultilinearExtension<scalar_field>>> &gxs,
        const std::vector<shared_ptr<DenseMultilinearExtension<scalar_field>>> &perms,
