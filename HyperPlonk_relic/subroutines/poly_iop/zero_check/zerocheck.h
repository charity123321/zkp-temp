...
///   - the initial challenge std::vector r which is used to build eq(x, r) in
///     SumCheck
///   - the random std::vector `v` to be evaluated
...
public:
        ...
        Transcript &transcript)
    {
        ...
        std::vector<F> r = transcript.get_and_append_challenge_vector<F>("0check r", length);
