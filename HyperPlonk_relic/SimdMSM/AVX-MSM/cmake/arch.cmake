...
message("   ARCH=A64       ARM 64-bit architecture.")
...
message(STATUS "Byte boundary to align digit std::vectors (default = 1):\n")

message("   ALIGN=1        Do not align digit std::vectors.")
message("   ALIGN=2        Align digit std::vectors into 16-bit boundaries.")
message("   ALIGN=8        Align digit std::vectors into 64-bit boundaries.")
message("   ALIGN=16       Align digit std::vectors into 128-bit boundaries.\n")
...
if(CMAKE_SYSTEM_PROCESSOR STREQUAL "arm64")
	set(ARCH "A64" CACHE STRING "Architecture")
endif()
...
set(ALIGN ${ALIGN} CACHE STRING "Boundary to align digit std::vectors")
